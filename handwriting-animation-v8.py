...
#strokeStart = r"C:\Users\laish\SurfaceStudio\Work\Blender\Sound\strokeSound\strokeStart01.wav"
#strokeMiddle = r"C:\Users\laish\SurfaceStudio\Work\Blender\Sound\strokeSound\strokeMiddle01.wav"

basePath = r"C:\Users\laish\SurfaceStudio\Work\Blender\Sound\bird\\"

strokeStart = r"C:\Users\laish\SurfaceStudio\Work\Blender\Sound\bird\start.wav"
strokeMiddle = r"C:\Users\laish\SurfaceStudio\Work\Blender\Sound\bird\middle.wav"

basePath = "C://Users//laish//SurfaceStudio//Work//Blender//Sound//chalk//"
#basePath = "C://Users//laish//SurfaceStudio//Work//Blender//Sound//bird//"
...
def linear_resample(original_list, new_length):
    if new_length <= 0:
        return []
    elif new_length == 1:
...
# Save JSON to a file
#json_path = r"C:\Users\laish\SurfaceStudio\Work\Blender\Sound\strokeSound\strokeStart01.json"
#with codecs.open(json_path, "w", encoding="utf-8") as f:
#    json.dump(strokeStartAudio, f, indent=4, ensure_ascii=False)
...
#print(strokeSpaceFrames)
#print(len(strokePressure))
...
def resampleAudio(volume = 1, startVolume = 0.8, middleVolume=0.2):
    sampleAudio = []
    ...
    for idx in range(strokeFrameLen):
        ...
        newstrokePressure = linear_resample(strokePressure[idx], sampleNum)
        newSamplePressure = newstrokePressure + spressureSpace

        
        startRandomPath= random.choice(start_path)    
        strokeStartAudio = getAudioInfo(startRandomPath)        
        middleRandomPath= random.choice(middle_path)    
        strokeMiddleAudio = getAudioInfo(middleRandomPath)
...
samples = resampleAudio(volume = 1, startVolume = 0.9, middleVolume=0.5)


# 使用 'wave' 模块创建 WAV 文件对象并设置参数
...
GPWritingSong = bpy.context.scene.sequence_editor.sequences.new_sound("GPWritingSong", output_file, 1, 1)
